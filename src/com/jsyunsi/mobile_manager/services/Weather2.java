...
public class Weather2 {
	...
	public static List<Map<String, Object>> getWeekWeatherMap(String Cityid) throws IOException, NullPointerException {
		// API
	...
	public static Map<String, Object> getTodayWeather1(String Cityid) throws IOException, NullPointerException {
		...
		try {
			...
			map.put("SD", info.getString("SD").toString());
			map.put("time", info.getString("time").toString());
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(map.get("city") + "\t" + map.get("temp") + "\t" + map.get("WD") + "\t" + map.get("WS")
					+ "\t" + map.get("SD") + "\t" + map.get("time"));

			Map<String, Object> map2 = getTodayWeather2("101010100");
			System.out.println(map2.get("city") + "\t" + map2.get("temp1") + "\t" + map2.get("temp2") + "\t"
			...
			for (int j = 0; j < listData.size(); j++) {
				...
				System.out.println(wMap.get("city") + "\t" + wMap.get("date_y") + "\t" + wMap.get("week") + "\t"
						+ wMap.get("weather") + "\t" + wMap.get("temp") + "\t" + wMap.get("wind") + "\t"
						+ wMap.get("fl"));
			}
